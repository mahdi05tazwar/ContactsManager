...
public class SearchRVAdapter extends RecyclerView.Adapter<SearchRVAdapter.CustomViewHolder> {
    // SAME AS THE RVADAPTER CLASS EXCEPT IT USES A DESTROYER
    ArrayList<Contacts> contacts;
    Context context;
    Destroyer destroyer;
    Copier copier;

    public SearchRVAdapter(ArrayList<Contacts> contacts, Context context, Copier copier) {
    ...
    public void setDestroyer(Destroyer destroyer) {this.destroyer = destroyer;}
    ...
    public class CustomViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener, View.OnLongClickListener {
        ...
        public boolean onLongClick(View view) {
            ...
            copier.copyToClipboard("Number copied to clipboard!", contact.getNumber());
            return true;
        }
    }
}
